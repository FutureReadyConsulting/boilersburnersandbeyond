...
const Faq = () => {
    ...
    const FaqContent = {
      img1:'/assets/img/faq1.jpg',
      img2:'/assets/img/faq2.jpg',
      Experience:'9+',
      BestAward:'Boilers Burners and Beyond',
      Content:'Welcome to our FAQ section! At Boilers Burners and Beyond, we understand that HVAC systems can be complex, and you may have questions about our services, maintenance, or how to improve your indoor comfort. Here, we’ve compiled answers to some of the most common questions we receive from our customers.'
    }
