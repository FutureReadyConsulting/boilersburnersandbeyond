    ...
    >
      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1 text-center">
          <SectionTitle
            Title="Explore Our HVAC Services"
            SubTitle="our best servicse"
          ></SectionTitle>
        </div>
            ...
            <div key={i} className="col-lg-4 col-md-6">
              <div className="cs_service_card cs_style_1 text-center">
                <div className="cs_service_card_in">
                  <p className="cs_service_card_number cs_center cs_fs_48 cs_bold cs_mb_22">
                    {item.id}
                  </p>
                  <h3 className="cs_service_card_title cs_fs_24 cs_semibold cs_mb_15">
                    {item.title}
                  </h3>
                  <p className="cs_service_card_subtitle cs_mb_15">
                    {item.desc}
                  </p>
                  <Link
                    to={item.link}
